...
int main(int argc, char *argv[])
{
    ...
    SharedNoiseModel measurementNoiseCauchy =
        noiseModel::Isotropic::Sigma(2, 1e-9 * measurementSigma);
    ...
    Matrix errorsLOSTOpt = Matrix::Zero(nrTrials, 3);
    Matrix errorsCauchy = Matrix::Zero(nrTrials, 3);
    ...
    for (int i = 0; i < nrTrials; i++)
    {
        ...
        auto estimateLOSTOpt = triangulatePoint3<Cal3_S2>(
            cameras, noisyMeasurements, rank_tol, true, measurementNoise, true);
        ...
        auto estimateCauchy = triangulateCauchy(
            cameras, noisyMeasurements, measurementNoise);
